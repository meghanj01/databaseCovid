...
try:
    ...
    cur.execute(
        """INSERT INTO Patients (patient_name, insurance) VALUES
    ...
    cur.execute(
        """INSERT INTO Appointment (start_time, end_time, duration, doctor_hospital_id) VALUES
    ...
    cur.execute(
        """INSERT INTO Doctor (registration_number, specilzation, hospital_id) VALUES
    ...
    cur.execute(
        """INSERT INTO Hospital (hospital_name, pincode) VALUES
